      ...
      <table class="table table-bordered" id="product-dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              @if($post->photo)
              <img src="{{asset('/uploads/images/posts'). '/' . $post->photo}}" class="img-fluid zoom" style="max-width:80px" alt="{{$post->photo}}">
              @else
              <img src="{{asset('backend/img/avatar.png')}}" class="img-fluid" style="max-width:80px" alt="avatar.png">
              @endif
            </td>
            <td>
