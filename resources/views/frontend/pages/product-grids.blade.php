                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{route('product-detail',$product->slug)}}">
                                        ...
                                        $photo=explode(',',$product->photo);
                                        @endphp -->
                                        <img class="default-img" src="{{asset('/uploads/images/products'). '/' . $product->photo}}" alt="{{$photo[0]}}">
                                        <img class="hover-img" src="{{asset('/uploads/images/products'). '/' . $product->photo}}" alt="{{$photo[0]}}">
                                        @if($product->discount)
