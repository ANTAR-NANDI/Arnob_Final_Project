						...
						<div class="product-gallery">
							...
							<div class="flexslider-thumbnails">
								<ul class="slides">
									...
									<li data-thumb="{{asset('/uploads/images/products'). '/' . $product_detail->photo}}" rel="adjustX:10, adjustY:">
										<img src="{{asset('/uploads/images/products'). '/' . $product_detail->photo}}" alt="{{$data}}">
									</li>
									@endforeach
								</ul>
							</div>
